...
// ── DEALS ──────────────────────────────────────────────────────────────
// Deals are accessible via payment routes (same endpoint for both roles)
...
export const markAllNotificationsRead = () => api.post("/notification/markAllNotificationsRead");
