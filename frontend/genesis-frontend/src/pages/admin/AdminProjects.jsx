...
import { CheckCircle, XCircle, Pause, Eye, X } from "lucide-react";
import { getPendingProjects, approveProject, rejectProject, suspendProject } from "../../api/admin";
              ...
              <div key={i} style={{ background:"white",borderRadius:20,overflow:"hidden",boxShadow:"0 2px 16px rgba(0,0,0,0.06)",transition:"all 0.3s" }}
                ...
                <div style={{ padding:18 }}>
                  ...
                  <div style={{ display:"grid",gridTemplateColumns:"1fr 1fr",gap:8,marginBottom:14 }}>
                    {[{l:"Target",v:`$${(p.targetAmount||0).toLocaleString()}`},{l:"Equity",v:`${p.equityAvailable||0}%`}].map(m=>(
                  ...
                  <div style={{ fontFamily:F.dm,fontSize:11,color:"rgba(13,6,33,0.4)",marginBottom:14 }}>
          ...
          <div style={{ background:"white",borderRadius:24,width:"100%",maxWidth:560,boxShadow:"0 40px 100px rgba(0,0,0,0.3)",overflow:"hidden",maxHeight:"90vh",overflowY:"auto" }}>
            ...
            <div style={{ padding:22 }}>
              ...
              <div style={{ display:"grid",gridTemplateColumns:"1fr 1fr 1fr",gap:10,marginBottom:18 }}>
                {[{l:"Target",v:`$${(selected.targetAmount||0).toLocaleString()}`},{l:"Equity",v:`${selected.equityAvailable||0}%`},{l:"Valuation",v:`$${(selected.valuation||0).toLocaleString()}`}].map(m=>(
