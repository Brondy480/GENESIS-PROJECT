...
import { CheckCircle, XCircle, UserX, UserCheck, Eye, X } from "lucide-react";
import { getPendingUsers, approveUser, rejectUser, suspendUser, unsuspendUser } from "../../api/admin";
            ...
            return (
              <div key={i} style={{ display:"grid",gridTemplateColumns:"2fr 1fr 1fr 1fr auto",alignItems:"center",padding:"14px 20px",borderBottom:"1px solid rgba(0,0,0,0.04)",transition:"background 0.15s" }}
                ...
                <div style={{ display:"flex",gap:6 }}>
                  <button onClick={()=>setSelected(u)} title="View Details" style={{ width:32,height:32,borderRadius:8,background:"#F5F3FF",border:"1px solid rgba(124,58,237,0.15)",display:"flex",alignItems:"center",justifyContent:"center",cursor:"pointer" }}>
